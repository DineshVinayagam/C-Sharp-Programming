...
namespace CollegeAdmission2
{
    ...
    public class StudentsDetails
    {
        ...
        public StudentsDetails(string data)
        {
        ...
        {
            System.Console.WriteLine("Registernumber is "+StudentId);
