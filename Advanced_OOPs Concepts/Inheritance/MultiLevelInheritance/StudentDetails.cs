...
namespace MultiLevelInheritance
{
    ...
    public class StudentDetails:PersonalDetails,IMarkDetails
    {
      ...
      Year=year;
       ...
       public StudentDetails(string studentID,string aadharnumber,string name,string fathersname, Gender gender, long phone, Department department):base( aadharnumber,name,fathersname,gender,phone)
      {
      StudentID=studentID;
      Department=department;
